...
namespace Bot
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            string token = "5749115506:AAHrPC-Iol5ARNRUuRVEXUjjkczhNTVQXP4";
            ...
            async Task HandleUpdateAsync(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
            {
                ...
                else if (messLow.StartsWith("Tiến "))
                {
                    reply = " là bạn Tiến lớp 56KMT";
                }
                else if (new[] { "duy", "thằng duy", "anh duy" }.Any(keyword => messLow.Contains(keyword)))
                {
                    reply = "Ý bạn là  Phương Minh Duy, Bắc Giang, học 56kmt trường DH Công nghiệp Thái Nguyên phải không. ";
                        
                }
                else if (messLow.StartsWith("56kmt"))
                {
                    reply = "ý bạn là Lớp 56KMT của trường TNUT phải không";
                }
                else
                {
        ...
        private void InitializeComponent()
        {
            ...
            // txtLog
            // 
            this.txtLog.Location = new System.Drawing.Point(187, 78);
            this.txtLog.Multiline = true;
            this.txtLog.Name = "txtLog";
            this.txtLog.Size = new System.Drawing.Size(445, 185);
